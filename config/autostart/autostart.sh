...
xinput set-prop 3 libinput\ Accel\ Profile\ Enabled 0, 1 &
xinput set-prop 4 libinput\ Accel\ Profile\ Enabled 0, 1 &
xinput set-prop 5 libinput\ Accel\ Profile\ Enabled 0, 1 &
xinput set-prop 6 libinput\ Accel\ Profile\ Enabled 0, 1 &
xinput set-prop 7 libinput\ Accel\ Profile\ Enabled 0, 1 &
